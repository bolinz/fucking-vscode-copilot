---
title: "Cloud agents in Visual Studio Code"
description: "Use cloud agents like GitHub Copilot cloud agent in VS Code to autonomously handle coding tasks with automatic pull request generation and team collaboration workflows."
source: "https://code.visualstudio.com/docs/copilot/agents/cloud-agents"
---

Cloud agents run on remote infrastructure and integrate with GitHub repositories for team collaboration through pull requests. For example, the GitHub Copilot cloud agent runs on GitHub's infrastructure and can implement features, address code review feedback, and open pull requests autonomously.
...
![Screenshot of cloud agent session as a chat editor in VS Code.](https://code.visualstudio.com/assets/docs/copilot/cloud-agents/cloud-agent-session.png)
...
VS Code supports different cloud agents, such as Copilot cloud agent and [third-party agents](https://code.visualstudio.com/docs/copilot/agents/third-party-agents) like Claude and Codex.
...
The **GitHub Copilot cloud agent** is the primary cloud agent available in VS Code with your Copilot subscription.
...
Learn more about [third-party agents in VS Code](https://code.visualstudio.com/docs/copilot/agents/third-party-agents) and how to enable them.
...
If you prefer to work in the browser, you can also start cloud agent sessions directly from GitHub.com using the [GitHub Copilot cloud agent](https://docs.github.com/en/copilot/how-tos/use-copilot-agents/manage-agents).
...
1. In the Chat view, select **New Chat** from the session list dropdown and choose **Cloud** from the session type dropdown
   Alternatively, you can run the **Chat: New Cloud Agent** command from the Command Palette (⇧⌘P (Windows, Linux Ctrl+Shift+P)).

2. Choose the cloud agent provider from the dropdown and optionally select a custom agent and model.

3. Enter your prompt and let the cloud agent work on the task
...
4. The cloud agent starts working on the task remotely. You can monitor the progress of the session in the Chat view and continue to interact with it.

> **Note** If you have assigned an issue or pull request to the Copilot cloud agent on GitHub.com, the session automatically appears in the session list in VS Code.
...
2. Select the session type dropdown, and select **Cloud** to continue the session as a cloud agent.
   If you're using the [Plan agent](https://code.visualstudio.com/docs/copilot/agents/planning), you can select **Continue in Cloud** from the **Start Implementation** dropdown to run the plan implementation in a cloud agent session
...
![Screenshot of cloud agent filter in VS Code Chat view.](https://code.visualstudio.com/assets/docs/copilot/cloud-agents/cloud-agent-filter.png)
...
- [Agents overview](https://code.visualstudio.com/docs/copilot/agents/overview): Understand different agent types and delegation
- [Background agents](https://code.visualstudio.com/docs/copilot/agents/copilot-cli): Learn about CLI-based autonomous agents for isolated development
- [Custom agents](https://code.visualstudio.com/docs/copilot/customization/custom-agents): Create custom agent roles and personas
