...
description: "Official documentation for Claude Code, Anthropic's agentic coding tool available in the terminal, IDE, desktop app, and browser."
...
For the complete documentation index, visit: https://code.claude.com/docs/llms.txt
